    ...
    <div :style="isSIgpt ? 'display: none;':'' ">
        ...
        >
            ...
            <template v-slot:action="{ attrs }">
                <v-btn v-if="gitSnackBar.title == 'Warning' && gitSnackBar.Text == 'Nothing changed' && !isOnPrem"
                        color="white"
                        outlined
                        small
                        v-bind="attrs"
        ...
        >
            ...
            <v-tabs v-model="gitTab"
                    :key="gitTabKey"
                    vertical
            >
                <v-tab v-for="item in gitTabItems"
                        :key="item.tab"
                ...
                >
                    ...
                    <v-tooltip right>
                        <template v-slot:activator="{ on }">
                            <v-icon v-if="item.tabKey == 'setAccount' && githubTokenError"
                                    v-on="on"
                                    end 
                                    color="error" 
                    ...
                    <v-card flat style="padding:10px;">
                        <div>
                            ...
                            <div v-if="item.tabKey == 'setAccount'" :disabled="!isListSettingDone">
                                <div style="margin: 10px;">
                                    ...
                                    <div v-if="!isGitLogin" style="width: 100%; text-align: center; margin-top: 10px; margin-bottom: -15px;">
                        ...
                        <div style="float: right;">
                            <div v-if="!isPushing && item.tabKey == 'setFirstRepo' && gitRadios == 'createNewRepo' || item.tabKey == 'changeRepo' && isExistRepoMessage == null">
                                <v-btn :disabled="!gitOrgName || !gitRepoName || isExistRepo" 
                                    text 
                                    color="primary" 
                                    @click="startCommit"
                            >
